...
class train_validation:
    ...
    def train_validation(self):
        try:
            ...
            # extracting values from training schem
            ...
            self.log_writer.log(self.file_object,
                                "Creating Project_Database and tables on the basis of given schema!!!")
            # create database with given name, if present open the connection! Create table with columns given in schema
            self.dBOperation.createTableDb('skuDatabase', column_names)
            self.log_writer.log(self.file_object, "Table creation Completed!!")
            self.log_writer.log(self.file_object, "Insertion of Data into Table started!!!!")
            # insert csv files in the table
            self.dBOperation.insertIntoTableGoodData('skuDatabase')
            ...
            self.dBOperation.selectingDatafromtableintocsv('skuDatabase')
